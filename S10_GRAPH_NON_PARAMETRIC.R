...
packages <- c("Rcpp", "RColorBrewer", "multcomp", "rcompanion", "scales", "grid", "glue", "rlang", "tibble", "gridGeometry", "sf", "png", "magick", "memoise",  "remotes", "effsize", "psych", "ARTool", "vcd", "AER", "dplyr", "alphaOutlier", "digest", "tidyr", "MASS", "ggplot2", "ggpattern", "pscl", "boot", "emmeans", "foreign", "nortest", "DHARMa", "lme4", "parallel", "doParallel", "doRNG", "lmtest") 
ipak(packages)
